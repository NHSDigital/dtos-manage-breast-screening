...
class ParticipantReportedMammogramForm(forms.Form):
    ...
    def __init__(self, participant, current_provider, *args, **kwargs):
        ...
        self.fields["where_taken"] = ChoiceField(
            ...
            conditional_fields={
                self.WhereTaken.UK: "somewhere_in_the_uk_details",
                self.WhereTaken.OUTSIDE_UK: "outside_the_uk_details",
            },
        )
        ...
        self.fields["when_taken"] = ChoiceField(
            ...
            conditional_fields={
                self.WhenTaken.APPROX: "approx_date",
                self.WhenTaken.EXACT: "exact_date",
            },
        )
