        ...
        assertHTMLEqual(
            ...
            <div class="nhsuk-card">
                <div class="nhsuk-card__content">
                    <h2 class="nhsuk-card__heading">Appointments</h2>
                    <h3>Upcoming</h3>
                    <table class="nhsuk-table" data-testid="upcoming-appointments-table">
                    <thead>
                        <tr>
                            <th>Date</th>
                            <th>Type</th>
                    ...
                    <tbody>
                        <tr data-testid="appointment-row">
                            ...
                            <td><strong class="app-nowrap nhsuk-tag nhsuk-tag--blue">Confirmed</strong></td>
                            <td><a href="/mammograms/e3d475a6-c405-44d6-bbd7-bcb5cd4d4996/">View details</a></td>
                        </tr>
                    </tbody>
                    </table>
                    <h3>Previous</h3>
                    <table class="nhsuk-table" data-testid="past-appointments-table">
                        <thead>
                        <tr>
                            <th>Date</th>
                            <th>Type</th>
                    ...
                    <tbody>
                        <tr data-testid="appointment-row">
                            ...
                            <td>Screening</td>
                            <td>West of London BSS</td>
                            <td><strong class="app-nowrap nhsuk-tag nhsuk-tag--orange">Partially screened</strong></td>
                        ...
                        <tr data-testid="appointment-row">
                            ...
                            <td>Screening</td>
                            <td>West of London BSS</td>
                            <td><strong class="app-nowrap nhsuk-tag nhsuk-tag--green">Screened</strong></td>
