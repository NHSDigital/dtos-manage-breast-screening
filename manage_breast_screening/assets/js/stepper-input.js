...
export class StepperInput extends ConfigurableComponent {
  ...
  constructor($root, config) {
    ...
    const $input = this.$root.querySelector('.app-js-stepper-input-input')
    if (!($input instanceof HTMLInputElement)) {
      throw new ElementError({
        component: StepperInput,
        element: $input,
        expectedType: 'HTMLInputElement',
        identifier: 'Form field (`.app-js-stepper-input-input`)'
      })
    }

    const $buttonStepDown = this.$root.querySelector(
      '.app-js-stepper-input-step-down'
    )
    ...
    if (!($buttonStepDown instanceof HTMLButtonElement)) {
      throw new ElementError({
        ...
        identifier: 'Step down button (`.app-js-stepper-input-step-down`)'
      })
    }

    const $buttonStepUp = this.$root.querySelector(
      '.app-js-stepper-input-step-up'
    )
    ...
    if (!($buttonStepUp instanceof HTMLButtonElement)) {
      throw new ElementError({
        ...
        expectedType: 'HTMLButtonElement',
        identifier: 'Step up button (`.app-js-stepper-input-step-up`)'
      })
    }
   ...
   */
  static moduleName = 'app-stepper-input'
...
/**
 * @import { createAll, InitOptions } from 'nhsuk-frontend'
