...
describe('Image map', () => {
  ...
  const multiPathSvg = `<div data-module="app-image-map">
    <svg viewBox="0 0 800 400">
      <path d="M452.25,344.67c-19.02-15.94-34.28-38.03-47.06-66.66h-5.19v121.99h160.32v-23.33c-2.01.06-4.06.09-6.13.09-43.13,0-76.02-10.35-101.94-32.09Z" fill="none">
        <title>a</title>
      <path d="M420.59,234.02h-20.59v43.99h5.19c12.78,28.63,28.04,50.72,47.06,66.66l21.62-28.95c-28.17-21.35-44.51-52.66-53.28-81.7Z" fill="none">
        <title>b</title>
      </path>
    </svg>
  </div>
